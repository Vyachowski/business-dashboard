  ...
  useEffect(() => {
    const fetchGoalsData = async () => {
      try {
        ...
        const yearlyResponseRevenue = await axios.get(`${baseUrl}/api/revenue/SEO/`, {
          params: {
        ...
        const monthlyResponseRevenue = await axios.get(`${baseUrl}/api/revenue/SEO/`, {
          params: {
        ...
        const weeklyResponseRevenue = await axios.get(`${baseUrl}/api/revenue/SEO/`, {
          params: {
            startDate: '2022-10-8',
            endDate: '2023-10-15',
            type: 'total',
