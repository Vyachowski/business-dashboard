  ...
  useEffect(() => {
    const fetchGoalsData = async () => {
      try {
        ...
        const responseRevenue = await axios.get('http://localhost:3011/api/revenue/PPC/', {
          params: {
        ...
        setGoals({
          annualGoal: ppcRevenueGoal,
          monthlyGoal: ppcRevenueGoal / 12,
          weeklyGoal: Math.floor(ppcRevenueGoal / 52),
        })
