...
const InsightsPopup: React.FC<InsightsPopupProps> = (props) => {
  const [insightDescription, setInsightDescription] = useState("");
  const handleAddInsightForm = async (e) => {
    e.preventDefault();
  ...
  const handleInsightDescriptionChange = (event) => {
    const newValue = event.target.value;
    setInsightDescription(newValue);
  };
  ...
  return (
    ...
    >
      <div className="relative m-auto w-full max-w-180 rounded-sm border border-stroke bg-gray p-4 shadow-default dark:border-strokedark dark:bg-meta-4 sm:p-8 xl:p-10">
        ...
        <form onSubmit={handleAddInsightForm}>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              onChange={handleInsightDescriptionChange}
