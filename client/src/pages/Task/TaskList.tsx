            ...
            >
              <div>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="insightCheckbox1" className="cursor-pointer">
                  ...
                  <label htmlFor="insightCheckbox2" className="cursor-pointer">
                    <div className="relative flex items-center pt-0.5">
                      <input
                          type="checkbox"
                          id="insightCheckbox2"
                  ...
                  <label htmlFor="insightCheckbox3" className="cursor-pointer">
                    <div className="relative flex items-center pt-0.5">
                      <input
                          type="checkbox"
                          id="insightCheckbox3"
